            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="admin-card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.vehicles.store') }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type"
                                            ...
                                            <option value="Sedan" {{ old('type') == 'Sedan' ? 'selected' : '' }}>Sedan
                                            </option>
                                            <option value="SUV" {{ old('type') == 'SUV' ? 'selected' : '' }}>SUV
                                            </option>
                                            <option value="Luxury" {{ old('type') == 'Luxury' ? 'selected' : '' }}>Luxury
                                            </option>
                                            <option value="Economy" {{ old('type') == 'Economy' ? 'selected' : '' }}>
                                                Economy</option>
                                            <option value="Truck" {{ old('type') == 'Truck' ? 'selected' : '' }}>Truck
                                            </option>
                                            <option value="Van" {{ old('type') == 'Van' ? 'selected' : '' }}>Van
                                            </option>
                                        </select>
                                        @error('type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('seating_capacity') }}" min="1" max="15"
                                            required>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            value="{{ old('current_mileage') }}" min="0" required>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-12">
                                        <div class="col-12">
                                            <label for="image" class="form-label">Vehicle Image <span
                                                    class="text-danger">*</span></label>
                                            <input type="file"
                                                class="form-control @error('image') is-invalid @enderror" id="image"
                                                name="image" accept="image/jpeg,image/png,image/gif" required>
                                            <div class="form-text">Upload vehicle image (JPG, PNG, GIF only, max 5MB) -
                                                Local storage for security</div>
                                            @error('image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
