...
<body>
    ...
    <div class="filters-section">
        ...
        @if(!empty($filters['date_range']))
            <div class="filter-item">📅 Date Range: {{ ucfirst(str_replace('_', ' ', $filters['date_range'])) }}</div>
        @endif
    </div>
    @endif
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="vehicle-name">{{ $booking->vehicle->make ?? 'N/A' }} {{ $booking->vehicle->model ?? '' }}</div>
                    <div class="vehicle-plate">{{ $booking->vehicle->license_plate ?? 'N/A' }}</div>
                </td>
                <td>
                    <div class="period-main">{{ \Carbon\Carbon::parse($booking->pickup_datetime)->format('M d, Y') }}</div>
                    <div class="period-sub">to {{ \Carbon\Carbon::parse($booking->return_datetime)->format('M d, Y') }}</div>
                </td>
